...
int main()
{
    ...
    cout << "Crossword CB using dictionary CB -> WITHOUT forward checking: " << endl;
    ...
    cout << "Crossword CB using dictionary CB -> WITH forward checking: " << endl;
    fileReader = CrosswordDeckFileReader("./data/crossword_CB_v2.txt");
    crosswordDictionary = CrosswordDictionary("./data/diccionari_CB.txt");
    ...
    cout << "Crossword CB using dictionary CB -> WITH forward checking -> WITH heuristic: " << endl;
    fileReader = CrosswordDeckFileReader("./data/crossword_CB_v2.txt");
    crosswordDictionary = CrosswordDictionary("./data/diccionari_CB.txt");
    crosswordDeck = CrosswordDeck(fileReader.getRows(), fileReader.getCols(), fileReader.getCharsList(), &crosswordDictionary);
    crosswordSolver = CrosswordSolver(&crosswordDeck, &crosswordDictionary);
    ...
    cout << "Crossword CB using dictionary A -> WITH forward checking -> WITH heuristic: " << endl;
    fileReader = CrosswordDeckFileReader("./data/crossword_CB_v2.txt");
    crosswordDictionary = CrosswordDictionary("./data/diccionari_A.txt");
    crosswordDeck = CrosswordDeck(fileReader.getRows(), fileReader.getCols(), fileReader.getCharsList(), &crosswordDictionary);
    crosswordSolver = CrosswordSolver(&crosswordDeck, &crosswordDictionary);
